/*
 Web client robotplace ping online status
...
#include <RobotPlace.h> //proxy's library
...
/****** TO MODIFY ACCORDING RobotPlace **********/
...
IPAddress server(46,28,111,207); // www.RobotPlace.com

RobotPlace rmdevice(authHash);
